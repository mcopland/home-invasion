...
/*
** Function used to validate long values entered by user.
**
** @param double     Minimum value allowed.
** @param double     Maximum value allowed.
*******************************************************************************/
long getValidLong(long min, long max) {
    ...
    // input validation
    while (cin.fail() || userLong < min || userLong > max) {
            cin.clear();
            cin.ignore(std::numeric_limits<std::streamsize>::max(),'\n');
            cout << "Enter a value between " << min << " and "
                 << max << ": ";
